...
Well we overwrote the `name` with A's and the pwntools python package helped us by `packing` the `0xdeadbeef` in 64 bits, little-endian with the `p64` function.  
